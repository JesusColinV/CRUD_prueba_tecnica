...
class Record(BaseModel):
    ...
    nombre:str = Field(
        ...
        example = "Jesus", 
        title = "Nombre" ,
        description = "Nombre de la persona del registro", 
        min_length = 3, 
        max_length = 20
        )
    primer_apellido:str = Field(
        ...
        description = "Primer apellido de la persona del registro", 
        min_length = 3, 
        max_length = 20
        )
    segundo_apellido:str = Field(
        ...
        description = "Segundo apellido de la persona del registro", 
        min_length = 3, 
        max_length = 20
        )
    estado_de_nacimiento:str = Field(
        ...
        description = "Entidad de nacimiento de la persona del registro", 
        min_length = 3, 
        max_length = 20
        )
    curp:str = Field(
        ...,
        title = "CURP",
        example = "COVJ980605HMCLLS03",
        description = "Clave unica de registro de población"
        )
    cp:int = Field(
        ...,
        title = "Codigo Postal",
        example = 50180,
        description = "Numeración regional"
        )
    rfc:str = Field(
        ..., 
        title = "RFC",
        example = "COVJ980605FJ5",
    ...
    telefono:str = Field(
        ...
        title = "telefono",
        example = "7225664556",
        description = "numero de comunicación telefonica", 
        min_length = 10, 
        max_length = 10
        )
